...
It renames all the occurrences of ext_moma (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the ext_moma folder
        os.rename(
            os.path.join(root_dir_path, "exts", "ext_moma", "ext_moma"),
            os.path.join(root_dir_path, "exts", "ext_moma", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "ext_moma"), os.path.join(root_dir_path, "exts", new_name))
